    ...
    <div className="min-h-screen text-white">
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-screen flex items-center justify-center px-6">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h1
            className={`text-6xl md:text-8xl lg:text-9xl mb-8 bg-gradient-to-r from-white via-blue-100 to-blue-400 bg-clip-text text-transparent transition-all duration-1000 ease-out animate-gradient-2 ${
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-3xl p-10 md:p-14 border border-slate-700/50 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:border-slate-600/50">
            <h2 className="text-4xl md:text-5xl font-bold mb-10 text-center bg-gradient-to-r from-blue-200 via-cyan-200 to-purple-300 bg-clip-text text-transparent animate-gradient-3">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className={`text-4xl md:text-5xl font-bold mb-16 text-center bg-gradient-to-r from-yellow-300 via-orange-300 to-pink-400 bg-clip-text text-transparent animate-gradient-pulse transition-all duration-1000 ease-out ${
